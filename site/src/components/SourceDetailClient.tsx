...
export default function SourceDetailClient({ source }: Props) {
    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4 text-center">
          <div className="text-2xl font-bold text-gray-800">
            {m.score_bias != null ? (m.score_bias as number > 0 ? "+" : "") + (m.score_bias as number).toFixed(1) : "N/A"}
          </div>
          <div className="text-xs text-gray-500 mt-1">Score Bias</div>
        </div>
      </div>
      ...
      {source.weights && "records" in source.weights && (source.weights as any).records.length > 0 && (
        <div className="bg-white rounded-xl border border-gray-200 p-4 mb-8">
          <h2 className="text-lg font-bold text-gray-800 mb-3">Weight Breakdown</h2>
      ...
      {source.recent_reviews && source.recent_reviews.length > 0 && (
        <div className="bg-white rounded-xl border border-gray-200 p-4 mb-8">
          <h2 className="text-lg font-bold text-gray-800 mb-3">Recent Reviews</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <h3 className="text-sm font-bold text-gray-700 mb-3">Genre Coverage</h3>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <h3 className="text-sm font-bold text-gray-700 mb-3">Platform Coverage</h3>
          <div className="space-y-1 text-sm">
