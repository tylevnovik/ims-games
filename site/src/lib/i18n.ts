...
const dict: Record<string, { zh: string; en: string }> = {
  ...
  "method.data_oc": { zh: "OpenCritic — 官方 API 或公开网页快照，提供评论者信息和出处", en: "OpenCritic — official API or public web snapshots providing individual critic reviews with outlet info" },
